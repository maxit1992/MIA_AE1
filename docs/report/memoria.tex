...
\reporttitle{Desafío práctico: Optimización por Enjambre de Partículas (PSO)} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
